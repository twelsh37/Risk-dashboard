...
app.layout = dbc.Container([html.Div([
    ...
    dbc.Row([
        dbc.Col([dcc.Graph(id='stats', figure=cards)], className='three columns', width=3),
        dbc.Col([dcc.Graph(id='stats2', figure=cards)], className='three columns', width=3),
        dbc.Col([dcc.Graph(id='stats3', figure=cards)], className='three columns', width=3),
...
# dbc.Row([
#         dbc.Col([dcc.Graph(id='stats', figure=cards)], width=6),
#         dbc.Col([dcc.Graph(id='control', figure=control)], width=3),
#         dbc.Col([dcc.Graph(id='control', figure=control)], width=3),
#     ]),
