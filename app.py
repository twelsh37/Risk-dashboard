...
test_2020, test_2021, test_2022, b_process, b_risk, b_controls, b_actions, a_process, a_risk, a_controls, a_actions, ca, cb\
    = sanity_check()
...
for column_header in ['control_activity']:
    controlactivity.add_trace(go.Histogram(x=test_2020[column_header], name='2020', marker={'color': '#AA4639'}))
    controlactivity.add_trace(go.Histogram(x=test_2021[column_header], name='2021', marker = {'color': '#AA7139'}))
    controlactivity.add_trace(go.Histogram(x=test_2022[column_header], name='2022', marker = {'color': '#255C69'}))
...
for column_header in ['de_oe']:
    de_oe.add_trace(go.Histogram(x=test_2020[column_header], name='2020', marker = {'color': '#AA4639'}))
    de_oe.add_trace(go.Histogram(x=test_2021[column_header], name='2021', marker = {'color': '#AA7139'}))
    de_oe.add_trace(go.Histogram(x=test_2022[column_header], name='2022', marker = {'color': '#255C69'}))
# Update the layout
